...
#define B2VEC2_TO_VEC2(vec) (*(bls::Vector2*)(&vec))
...
namespace bls
{
	...
	public:
		...
		void SetCollisionBox(b2Body* body, const CollisionData& data, class GameObject* object = nullptr);
		void SetCollisionBoxStatic(b2Body* body, const CollisionData& data, class GameObject* object = nullptr);
