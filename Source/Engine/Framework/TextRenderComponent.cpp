...
namespace bls
{
	CLASS_DEFINE(TextRenderComponent)
	...
	{
		if (!fontName.empty()) m_text = std::make_unique<bls::Text>(GET_RESOURCE(Font, fontName, fontSize));
	...
	void TextRenderComponent::Read(const rapidjson::Value& value)
	{
